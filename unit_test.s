...
unit_test_arithmetic
	...
	ARITHMETIC_TEST_SINGLE #100,neg_,#-100
	ARITHMETIC_TEST_SINGLE #-100,neg_,#100
	ARITHMETIC_TEST_SINGLE #0,neg_,#0


	TEST_NAME 'not_'

	ARITHMETIC_TEST_WW #$0f0f,not_,#$f0f0
	ARITHMETIC_TEST_LL #$0f0f0f0f,not_,#$f0f0f0f0


	TEST_NAME 'abs'

	ARITHMETIC_TEST_SINGLE #0,abs,#0
	ARITHMETIC_TEST_SINGLE #100,abs,#100
	ARITHMETIC_TEST_SINGLE #-100,abs,#100


	TEST_NAME 'square12f'

	ARITHMETIC_TEST_WW #0,square12f,#0
	ARITHMETIC_TEST_WW #$1000,square12f,#$1000
	ARITHMETIC_TEST_WW #-$1000,square12f,#$1000
	ARITHMETIC_TEST_WW #$2000,square12f,#$4000
	ARITHMETIC_TEST_WW #-$2000,square12f,#$4000
	ARITHMETIC_TEST_WW #$800,square12f,#$400
	ARITHMETIC_TEST_WW #-$800,square12f,#$400

	ARITHMETIC_TEST_WL #0,square12f,#0
	ARITHMETIC_TEST_WL #$1000,square12f,#$1000
	ARITHMETIC_TEST_WL #-$1000,square12f,#$1000
	ARITHMETIC_TEST_WL #$2000,square12f,#$4000
	ARITHMETIC_TEST_WL #-$2000,square12f,#$4000
	ARITHMETIC_TEST_WL #$4000,square12f,#$10000
	ARITHMETIC_TEST_WL #-$4000,square12f,#$10000
	ARITHMETIC_TEST_WL #$800,square12f,#$400
	ARITHMETIC_TEST_WL #-$800,square12f,#$400
	...
	ARITHMETIC_TEST_WWW #$1000,#4,lsr_,#$0100
	ARITHMETIC_TEST_WWW #$f000,#4,lsr_,#$0f00
	ARITHMETIC_TEST_LWL #$10000000,#4,lsr_,#$01000000
	ARITHMETIC_TEST_LWL #$f0000000,#4,lsr_,#$0f000000


	TEST_NAME 'lsl_'

	ARITHMETIC_TEST_WWW #$0ff0,#4,lsl_,#$ff00
	ARITHMETIC_TEST_WWW #$f000,#4,lsl_,#$0000
	ARITHMETIC_TEST_LWL #$0ff00000,#4,lsl_,#$ff000000
	ARITHMETIC_TEST_LWL #$f0000000,#4,lsl_,#$00000000
